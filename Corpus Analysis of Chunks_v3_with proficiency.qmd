...
fm12 <- glmer(IA_FIXATION_COUNT ~ MWS_Length_CENTER+
                ...
                Proficiency_CENTER+
                GROUP_sum*(Adj_Word_Frequency_scale_center+Noun_Word_Frequency_scale_center)*MWS_Frequency_scale_center+ 
                 ( Noun_Word_Frequency_scale_center |PP_ID) + (1|IA_LABEL) , data = Data_all, family= poisson) 
...
vif(fm_final_noun_FFD)
```

### Plot GROUP:Noun_Word_Frequency_scale_center

```{r}
#| label: plot <GROUP_sum:Noun_Word_Frequency_scale_centerr>-noun_FFD


effectXY_noun_FFD<-as.data.frame(effect("GROUP_sum:Noun_Word_Frequency_scale_center", fm_final_noun_FFD))
effectXY_noun_FFD$pred_ms <- effectXY_noun_FFD$fit 
effectXY_noun_FFD$se_ms <- effectXY_noun_FFD$se

ggplot(effectXY_noun_FFD, aes(y = pred_ms, x= Noun_Word_Frequency_scale_center, color = GROUP_sum ))+
  geom_smooth(aes( group= GROUP_sum  ), method="lm",size=0.6)+
  geom_point(aes())+
  geom_errorbar(aes ( ymin=pred_ms-se_ms, ymax=pred_ms+se_ms,  width=0.3))
```
...
### Report final model for First Run Dwell Time
...
vif(fm_final_noun_skip)
```

### Plot GROUP : MWS_Frequency

```{r}
#| label: plot <GROUP_sum:MWS_Frequency_scale_center>-noun_skip 

effectXY_noun_skip <-as.data.frame(effect("GROUP_sum:MWS_Frequency_scale_center", fm_final_noun_skip))
effectXY_noun_skip$pred_ms <- effectXY_noun_skip$fit
effectXY_noun_skip$se_ms <-  effectXY_noun_skip$se

ggplot(effectXY_noun_skip, aes(y = pred_ms, x= MWS_Frequency_scale_center, color = GROUP_sum))+
  geom_smooth(aes( group= GROUP_sum), method="lm",size=0.6)+
  geom_point(aes())+
  geom_errorbar(aes ( ymin=pred_ms-se_ms, ymax=pred_ms+se_ms,  width=0.3))
...
```{r}
#| label: plot <Noun_Word_Frequency:MWS_Frequency_scale_center>-noun_skip 

effectXY_noun_skip <-as.data.frame(effect("Noun_Word_Frequency_scale_center:MWS_Frequency_scale_center", fm_final_noun_skip))
effectXY_noun_skip$pred_ms <- effectXY_noun_skip$fit
effectXY_noun_skip$se_ms <-  effectXY_noun_skip$se

ggplot(effectXY_noun_skip, aes(y = pred_ms, x= Noun_Word_Frequency_scale_center, color = MWS_Frequency_scale_center))+
  geom_smooth(aes( group= MWS_Frequency_scale_center), method="lm",size=0.6)+
  geom_point(aes())+
  geom_errorbar(aes ( ymin=pred_ms-se_ms, ymax=pred_ms+se_ms,  width=0.3))
...
effectXY_noun_count<-as.data.frame(effect("GROUP_sum:MWS_Frequency_scale_center", fm_final_noun_count))
effectXY_noun_count$pred_ms <- effectXY_noun_count$fit
effectXY_noun_count$se_ms <- effectXY_noun_count$se


ggplot(effectXY_noun_count, aes(y = pred_ms, x= MWS_Frequency_scale_center, color = GROUP_sum ))+
  geom_smooth(aes( group= GROUP_sum ), method="lm",size=0.6)+
  geom_point(aes())+
  geom_errorbar(aes ( ymin=pred_ms-se_ms, ymax=pred_ms+se_ms,  width=0.3))
...
```{r}
#| label: plot <Noun_Word_Frequency_scale_center:MWS_Frequency_scale_center>-noun-count


effectXY_noun_count<-as.data.frame(effect("Noun_Word_Frequency_scale_center:MWS_Frequency_scale_center", fm_final_noun_count))
effectXY_noun_count$pred_ms <- effectXY_noun_count$fit
effectXY_noun_count$se_ms <- effectXY_noun_count$se


ggplot(effectXY_noun_count, aes(y = pred_ms, x= MWS_Frequency_scale_center, color = Noun_Word_Frequency_scale_center ))+
  geom_smooth(aes( group= Noun_Word_Frequency_scale_center), method="lm",size=0.6)+
  geom_point(aes())+
  geom_errorbar(aes ( ymin=pred_ms-se_ms, ymax=pred_ms+se_ms,  width=0.3))

ggplot(effectXY_noun_count, aes(y = pred_ms, x= Noun_Word_Frequency_scale_center, color = MWS_Frequency_scale_center ))+
  geom_smooth(aes( group= MWS_Frequency_scale_center ), method="lm",size=0.6)+
  geom_point(aes())+
  geom_errorbar(aes ( ymin=pred_ms-se_ms, ymax=pred_ms+se_ms,  width=0.3))
```
